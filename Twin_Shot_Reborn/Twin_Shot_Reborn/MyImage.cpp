...
{
	MyDraw(hdc, RECT{ dstRect.left - windowLeft , dstRect.top, dstRect.right - windowLeft, dstRect.bottom }, srcRect, reverseX, reverseY, bSrcAlpha);
}

void MyImage::MyDraw(HDC hdc, const RECT& dstRect, bool reverseX, bool reverseY, BYTE bSrcAlpha) const
{
	MyDraw(hdc, dstRect, RECT{ 0, 0, getWidth(), getHeight() }, reverseX, reverseY, bSrcAlpha);
}

void MyImage::MyDraw(HDC hdc, const RECT& dstRect, int windowLeft, bool reverseX, bool reverseY, BYTE bSrcAlpha) const
{
	MyDraw(hdc, RECT{ dstRect.left - windowLeft , dstRect.top, dstRect.right - windowLeft, dstRect.bottom }, reverseX, reverseY, bSrcAlpha);
}
